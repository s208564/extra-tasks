# Technical Report: Data Manipulation with Pandas Library

## Overview
This document outlines the technical approach used to process and analyze three distinct datasets. The primary focus was to demonstrate proficiency in **Pandas** core functionalities, including data ingestion, indexing, vectorized operations, and the **Split-Apply-Combine** pattern.

---

## 1. Data Ingestion and Structural Analysis (Exercise 1)
The first phase involved handling a pipe-separated (`|`) user dataset to establish a baseline for structural data exploration.
...
## 3. The Split-Apply-Combine Workflow (Exercise 3)
The final task utilized a global drinks dataset to demonstrate powerful data aggregation techniques via the **GroupBy** object.
